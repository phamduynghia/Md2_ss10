...
import bt3.ra.entity.Categories;
import bt3.ra.entity.Product;
...
public class ShopManagement {
    ...
    private static final Product[] arrProducts = new Product[100];
    ...
    private static void sortProductsByPrice() {
        ArrayList<Product> productList = new ArrayList<>(Arrays.asList(arrProducts).subList(0, productCount));
